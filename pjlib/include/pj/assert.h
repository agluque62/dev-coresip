...
#else
// #   define PJ_ASSERT_RETURN(expr,retval)    pj_assert(expr) AGL2015...Para que no caiga las versiones RELEASE
...
#else
// #   define PJ_ASSERT_ON_FAIL(expr,exec_on_fail)    pj_assert(expr)	AGL2015...Para que no caiga las versiones RELEASE
#   define PJ_ASSERT_ON_FAIL(expr,exec_on_fail)    if (!(expr)) exec_on_fail;
#endif
