...
/**
 * Si esta etiqueta esta definida al valor 0, entonces se rechazan las solicitudes recibidas
 * para subscribirse al evento de presencia.
 *
 */
#ifndef PJ_PRESENCE_EVENT_SERVER_ENABLED 
#  define PJ_PRESENCE_EVENT_SERVER_ENABLED 0
#endif
