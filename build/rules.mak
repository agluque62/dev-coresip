...
#
# The full path of output shared lib file (e.g. ../lib/libapp.so).
#
SHAREDLIB = $($(APP)_SHARED_LIB)
...
$(SHAREDLIB): $(OBJDIRS) $(OBJS) $($(APP)_EXTRA_DEP)
	if test ! -d $(LIBDIR); then $(subst @@,$(subst /,$(HOST_PSEP),$(LIBDIR)),$(HOST_MKDIR)); fi
	$(LD) $(LDOUT) $(SHAREDLIB) $(OBJS) $($(APP)_LDFLAGS)
