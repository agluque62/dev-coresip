/* $Id: sip_config.h 2762 2009-06-15 16:03:40Z bennylp $ */
/* 
...
typedef struct pjsip_cfg_t
{
	...
	unsigned tsx_tout;
	unsigned inv_proceeding_ia_tout;
	unsigned inv_proceeding_monitoring_tout;
	unsigned inv_proceeding_dia_tout;
	unsigned inv_proceeding_rd_tout;
    } tsx;
...
#define PJSIP_MAX_FORWARDS_VALUE	19
...
#if !defined(PJSIP_TSX_TIMEOUT)
#  define PJSIP_TSX_TIMEOUT	(64 * PJSIP_T1_TIMEOUT)
#endif

#if !defined(PJSIP_INV_PROCEEDING_IA_TIMEOUT)
#  define PJSIP_INV_PROCEEDING_IA_TIMEOUT	60000
#endif

#if !defined(PJSIP_INV_PROCEEDING_DIA_TIMEOUT)
#  define PJSIP_INV_PROCEEDING_DIA_TIMEOUT	60000
#endif

#if !defined(PJSIP_INV_PROCEEDING_RD_TIMEOUT)
#  define PJSIP_INV_PROCEEDING_RD_TIMEOUT	60000
#endif
 ...
 * Lo cambio por (3 minutos)
 */
#ifndef PJSIP_PRES_DEFAULT_EXPIRES
#   define PJSIP_PRES_DEFAULT_EXPIRES	180		//600
#endif
