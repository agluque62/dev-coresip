...
PJ_DECL(pjsip_from_hdr *) pjsip_publishc_get_from_hdr(pjsip_publishc *pubc);
 ...
 * @param refresh_timer_cb    Pointer to callback function of timer used to refresh publish. If it is NULL then
 *					an internal function is used.
...
PJ_DECL(pj_status_t) pjsip_publishc_create( pjsip_endpoint *endpt, 
						...
						pj_timer_heap_callback	*refresh_timer_cb,
