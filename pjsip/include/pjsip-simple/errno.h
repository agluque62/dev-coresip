 ...
 * WG67 KEY-IN ERRORS
 ***********************************************************/
#define PJSIP_SIMPLE_ENOWG67			(PJSIP_SIMPLE_ERRNO_START+27) /*270027*/
#define PJSIP_SIMPLE_EBADWG67			(PJSIP_SIMPLE_ERRNO_START+28) /*270028*/


 /************************************************************
 * CONFERENCE SUBSCRIPTION ERROR
 ***********************************************************/
 /**
 * @hideinitializer
 * No conference associated with subscription
 */
#define PJSIP_SIMPLE_ENOCONFERENCE    (PJSIP_SIMPLE_ERRNO_START+29)   /*270029*/
 /**
 * @hideinitializer
 * No conference info in server subscription
 */
#define PJSIP_SIMPLE_ENOCONFERENCEINFO (PJSIP_SIMPLE_ERRNO_START+30)  /*270030*/
 /**
 * @hideinitializer
 * Bad CIDF Message
 */
#define PJSIP_SIMPLE_EBADCIDF	    (PJSIP_SIMPLE_ERRNO_START+31)   /*270031*/
...
#define PJSIP_SIMPLE_EBADISCOMPOSE  (PJSIP_SIMPLE_ERRNO_START+40)   /*270040*/
 ...
 /************************************************************
 * DIALOG SUBSCRIPTION ERROR
 ***********************************************************/
 /**
 * @hideinitializer
 * No dialog associated with subscription
 */
#define PJSIP_SIMPLE_ENODIALOG    (PJSIP_SIMPLE_ERRNO_START+41)   /*270041*/
 /**
 * @hideinitializer
 * No dialog info in server subscription
 */
#define PJSIP_SIMPLE_ENODIALOGINFO (PJSIP_SIMPLE_ERRNO_START+42)  /*270042*/
